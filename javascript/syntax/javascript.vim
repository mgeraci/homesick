...
"" Michael likes things a certain way
syntax match   jsThis               /this\.*[\w]*/
syntax match   jsConstant           /\<[A-Z]\w\+\>/
hi def link jsThis Identifier
hi def link jsObjectKey Identifier
hi def link jsConstant StorageClass

syntax region jsImportContainer      start="^\s\?import \?" end=";\|$" contains=jsModules,jsConstant,jsModuleWords,jsLineComment,jsComment,jsStringS,jsStringD,jsTemplateString,jsNoise,jsBlock
...
"" Michael sez: commenting these out to keep a syntax highlighting error from
"" appearing on inline fat-arrow functions
